                                       ...
                                       completionBlock:^(BOOL success, NSError* error) {
                                         if (success) {
                                           ...
                                           switch (result) {
                                             ...
                                             case kGCMergeAnalysisResult_Normal: {
                                               let alert = [[NSAlert alloc] init];
                                               alert.messageText = [NSString localizedStringWithFormat:NSLocalizedString(@"Do you want to merge or rebase the branch “%@”?", nil), branch.name];
                                               alert.informativeText = [NSString localizedStringWithFormat:NSLocalizedString(@"The branch “%@” has diverged from its upstream and cannot be fast-forwarded.", nil), branch.name];
